...
export function VoiceProblemNotice() {
  ...
  return (
    <p role="status" className="w-full text-sm text-amber-700/80">
...
export default function VoiceToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-full border border-ink/10 bg-ink/[0.04] h-9 px-2.5 py-2 text-sm text-mist/60 backdrop-blur transition-colors hover:border-calm/30 hover:text-mist focus-visible:outline-2 focus-visible:outline-calm/60 aria-pressed:text-calm sm:px-4"
    >
