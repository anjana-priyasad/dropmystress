    ...
    <main className="min-h-dvh">
      ...
      <div className="mx-auto max-w-3xl px-5 py-6 sm:px-8">
        ...
        <div className="py-12 sm:py-16">
          <h1 className="mb-4 font-serif text-4xl text-white/90">You don&apos;t have to go through this alone.</h1>
        ...
        <div className="flex flex-col gap-4">
          <Panel className="border-rose-400/30 bg-rose-500/5">
            <div className="flex gap-4">
              <Siren className="mt-1 size-6 shrink-0 text-rose-300" aria-hidden />
              <div>
                <h2 className="mb-1 text-lg font-medium text-white">In immediate danger?</h2>
                <p className="text-mist/75">
                  Call your local emergency number now (for example <strong className="text-white">1990</strong> for an
                  ambulance in Sri Lanka, <strong className="text-white">911</strong> in the US, <strong className="text-white">999</strong>{" "}
                  in the UK, or <strong className="text-white">112</strong> in the EU), or go to the nearest hospital
          ...
          <Panel>
            <h2 className="mb-5 flex items-center gap-2 text-lg font-medium text-white">
            ...
            <ul className="flex flex-col divide-y divide-mist/10">
              {HELPLINES.map((line) => (
                <li key={line.region} className="flex flex-col gap-1 py-4 first:pt-0 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="text-white/90">{line.name}</p>
              ...
              <li className="flex flex-col gap-1 py-4 last:pb-0 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-white/90">Find A Helpline</p>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 self-start rounded-full border border-mist/15 px-4 py-2 text-mist/80 transition-colors hover:border-mist/30 hover:text-white sm:self-auto"
                >
        ...
        <p className="py-12 text-center text-sm text-mist/45">
          When you feel ready, the <Link href="/tools/grounding" className="text-mist/70 underline underline-offset-2 hover:text-white">grounding exercise</Link>{" "}
          or <Link href="/tools/breathing" className="text-mist/70 underline underline-offset-2 hover:text-white">breathing patterns</Link> can
          help in the moment.
        </p>
      </div>
    </main>
